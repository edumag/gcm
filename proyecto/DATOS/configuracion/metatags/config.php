...
$config['keywords'][0]='programación';
$config['keywords'][1]='informática';
$config['keywords'][2]='linux';
$config['keywords'][3]='php';
$config['keywords'][4]='bash';
$config['keywords'][5]='javascript';
$config['keywords'][6]='css';
$config['keywords'][7]='ajax';
